...
if (header) {
  // Add a check in case header doesn't exist
  console.log("heelo");
...
function runPageSpecificJS() {
  ...
  if (isProjectPage) {
    __webpack_require__.e(/*! import() */ "src_js_project-animations_js").then(__webpack_require__.bind(__webpack_require__, /*! ./project-animations.js */ "./src/js/project-animations.js")).then(function (module) {
      module.initProjectAnimations(lenis); // Pass lenis
    })["catch"](function (err) {
      return console.error('Error loading project animations:', err);
    });
  }

  // Check for about page
  var isAboutPage = document.querySelector('#lottie-cooking');
  if (isAboutPage) {
    Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_lottie-web_build_player_lottie_js"), __webpack_require__.e("src_js_about-animations_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./about-animations.js */ "./src/js/about-animations.js")).then(function (module) {
      return module.initAboutAnimations();
    })["catch"](function (err) {
      return console.error('Error loading about animations:', err);
    });
  }

  // Check for playground page
  var isPlaygroundPage = document.querySelector('#lottie-playground');
  if (isPlaygroundPage) {
    Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_lottie-web_build_player_lottie_js"), __webpack_require__.e("src_js_playground-animations_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./playground-animations.js */ "./src/js/playground-animations.js")).then(function (module) {
      return module.initPlaygroundAnimations();
    })["catch"](function (err) {
      return console.error('Error loading playground animations:', err);
    });
  }
}
...
if (cursor && window.matchMedia("(pointer: fine)").matches) {
  ...
  var linkTargets = document.querySelectorAll('a, button, .project-card');
